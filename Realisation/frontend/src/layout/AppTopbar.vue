...
const isLoggedIn = ref(true); // You can get this from your auth store/composable
const user = ref({ name: 'John Doe' }); // Get from your auth state
...
const handleLogout = async () => {
  try {
    ...
    // Update your auth state (you might have a composable/store for this)
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <div class="relative">
                        ...
                        <div class="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-50 border border-gray-200 dark:border-gray-700">
